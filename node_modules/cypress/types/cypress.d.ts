...
declare namespace Cypress {
  ...
  interface ResolvedConfigOptions<ComponentDevServerOpts = any> {
     ...
     * Padrão Glob para determinar quais arquivos de teste carregar.
     */
    specPattern: string | string[]
    /**
     * The user agent that the browser sends in all request headers.
     * O agente do usuário que o navegador envia em todos os cabeçalhos de solicitação.
     */
